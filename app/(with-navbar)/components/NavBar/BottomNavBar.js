  ...
  return (
    <>
      ...
      <nav className='w-full fixed bg-[#171e26] bottom-0 z-50 md:hidden grid grid-cols-4 overflow-x-auto h-auto backdrop-blur-md bg-opacity-80'>
        <Link href='/' className='flex flex-col text-xs items-center justify-center p-3 text-white'>
        ...
        <div className='flex flex-col text-xs items-center justify-center p-3 text-white'>
          <button className='relative flex flex-col items-center justify-center' onClick={() => setState(prevState => !prevState)}>
        ...
        <div className='flex items-center justify-center p-3 flex-col text-xs text-white'>
          <CartModal />
          <span>Carrito</span>
        </div>
